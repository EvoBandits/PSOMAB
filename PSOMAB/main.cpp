...
int main(){
    ...
    for(unsigned i=1; i<=number_of_samples; i++){
        ...
        PSOMAB instance(10000, m, MR, CR, 0.1, 0, 1, seed, x_lb, x_ub); //itarations, population_size, mutation_rate, crossover_rate, mutation_span , objective ( 0=min, 1=max), 1== sim obs
